...
const projectData = {
    ...
    "location": "대한민국",
    "year": "2024",
    "heroImage": "/projects/gaebong/img1.webp",
    "layout": "minimal-overlay",
    "description": [
    ...
    "titleEn": "Gaebong Social Welfare Center",
    "category": "Cultural"
};

async function restoreProject() {
    console.log('Starting restore process for:', projectData.title);
    ...
    if (error) {
        ...
        console.log('Successfully restored project!');
        console.log(data);
    }
}
